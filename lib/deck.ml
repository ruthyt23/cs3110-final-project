...
let money_cards = [
  ...
  (* 5 $2M money cards *)
  Money 2; Money 2; Money 2; Money 2; Money 2;
...
let action_cards = [
  ...
  Action "Deal Breaker"; Action "Deal Breaker";
  
  (* 3 Just Say No cards *)
  Action "Just Say No"; Action "Just Say No"; Action "Just Say No";
  
  (* 3 Sly Deal cards *)
  Action "Sly Deal"; Action "Sly Deal"; Action "Sly Deal";
  
  (* 4 Forced Deal cards *)
  Action "Forced Deal"; Action "Forced Deal"; Action "Forced Deal"; Action "Forced Deal";
  
  (* 3 Debt Collector cards *)
  Action "Debt Collector"; Action "Debt Collector"; Action "Debt Collector";
  
  (* 3 It's My Birthday cards *)
  Action "It’s My Birthday"; Action "It’s My Birthday"; Action "It’s My Birthday";
  
  (* 10 Pass Go cards *)
  Action "Pass Go"; Action "Pass Go"; Action "Pass Go"; Action "Pass Go"; Action "Pass Go";
  Action "Pass Go"; Action "Pass Go"; Action "Pass Go"; Action "Pass Go"; Action "Pass Go";
  
  (* 3 House cards *)
  Action "House"; Action "House"; Action "House";
  
  (* 3 Hotel cards *)
  Action "Hotel"; Action "Hotel"; Action "Hotel";
  
  (* 2 Double the Rent cards *)
  Action "Double The Rent"; Action "Double The Rent";
]
in property_cards @ money_cards @ action_cards
